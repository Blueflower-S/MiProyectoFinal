...
import com.portfolio.sc.Dto.dtoEducacion;
import com.portfolio.sc.Entity.Educacion;
import com.portfolio.sc.Security.Controller.Mensaje;
import com.portfolio.sc.Service.Seducacion;
...
@CrossOrigin(origins = "https://frontendfinal26.web.app") //cambiada
public class CEducacion {
    ...
    if(StringUtils.isBlank(dtoeducacion.getNombreE())){
        return new ResponseEntity(new Mensaje("Campo no puede estar vacío"), HttpStatus.BAD_REQUEST);
        }
